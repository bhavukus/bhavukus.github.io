      ...
      <div className="glass rounded-3xl p-8 md:p-12">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-4 max-w-md text-sm text-muted-foreground">Currently taking on select engagements for Q1 2026. Reply within 24 hours.</p>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/10 pt-6 text-xs text-muted-foreground md:flex-row md:items-center md:justify-between">
          <div>© 2026 Alex Chen. Crafted with intention.</div>
